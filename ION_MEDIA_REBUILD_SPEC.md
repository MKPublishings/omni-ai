# ION Ai Media Rebuild Spec (ION-Native)

## Goal
Rebuild image/video/GIF generation as an ION-native subsystem where ION is the single execution engine for diffusion workloads and all orchestration is modular, observable, and safety-governed.
...
- Throughput:
  ...
  - GPU workers keep warm ION model instances.
- Cost envelope:
...
## ION Model Registry (Canonical IDs)
- image_default
- image_hd
- video_default
- video_long
...
- Worker layer performs ION generation with pre-loaded model clients.
...
5. Full cutover to ION-native path

## Deliverables in this repo (initial scaffold)
- Python ION-native offline engine interfaces for image/video/GIF
