  ...
  ({ searchValue, onSearchChange, breadcrumbs = [], className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={clsx(
          'h-14 ix-glass-ambient border-b border-quantum-white/8 px-6 flex items-center justify-between',
          className
        )}
        {...props}
      >
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="w-8 h-8 bg-spectral-cyan-500 rounded-full flex items-center justify-center ml-2">
