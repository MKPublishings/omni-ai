        ...
        <main className="flex-1 py-6 sm:py-8 md:py-10">
          <header className="grid gap-6 sm:gap-8 lg:grid-cols-[minmax(0,1.2fr)_minmax(280px,0.8fr)] lg:items-end">
            <div>
              ...
              <h1 className="theme-public-title mt-4 max-w-5xl text-[2.45rem] font-semibold leading-[0.98] tracking-[-0.03em] text-quantum-white sm:text-[3.2rem] md:text-[4.25rem] lg:text-[5.25rem]">{title}</h1>
