/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5391e0667c8971774a0f76126230ad66)
// Runtime types generated with workerd@1.20251217.0 2024-11-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "WorldStateBusDurableObject";
	}
	interface Env {
		ION_ENV: "production";
		...
		OMNI_MEDIA_PROVIDER_TIMEOUT_SEC: string;
		OMNI_MEDIA_PROVIDER_HEALTH_URL: string;
		APP_BASE_URL: string;
		...
		WORLD_STATE_BUS: DurableObjectNamespace<import("./src/worker").WorldStateBusDurableObject>;
		DB: D1Database;
		AI: Ai;
		ASSETS: Fetcher;
	}
